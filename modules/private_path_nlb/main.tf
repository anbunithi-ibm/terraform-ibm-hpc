module "private_path_nlb" {
  # source                             = "terraform-ibm-modules/terraform-ibm-vpc-private-path/ibm"
  # version                            = "1.3.2"
  source                             = "git::https://github.com/terraform-ibm-modules/terraform-ibm-vpc-private-path?ref=main"
